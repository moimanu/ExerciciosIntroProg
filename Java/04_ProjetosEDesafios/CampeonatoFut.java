...
public class CampeonatoFut {
    ...
    static ArrayList<ClasseTime> tabelaTimes = new ArrayList<>(Arrays.asList());
    ...
    private static void ajustarPosicao(ClasseTime timeFut){ //Só consegui resolver para os pontos...
    ...
    private static void cadastrarTime(){
        ...
        tabelaTimes.add(new ClasseTime(nome));
